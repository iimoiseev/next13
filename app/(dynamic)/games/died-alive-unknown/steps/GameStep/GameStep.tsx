...
const GameStep: React.FC<GameStepProps> = ({ game, next }) => {
  ...
  const [characterId, setCharacterId] = React.useState(
    getRandomCharactersId(counts.character)
  );
      ...
      <div className={styles.game}>
        ...
        {getCharacterForDeadOrAliveOrUnknownGameQuery.data?.success && (
          <div className={styles.character}>
            ...
            <Image
              src={
                getCharacterForDeadOrAliveOrUnknownGameQuery.data.response.image
              }
        ...
        <div className={styles.buttons}>
          ...
          <Button onClick={() => onOptionClick('alive')}>❤️ alive</Button>
